...
import com.creditkarma.logx.base.PortalController
...
/**
  ...
  * [[com.creditkarma.logx.PortalCaster]] will instantiate the factory class from the properties file using basic java reflection.
