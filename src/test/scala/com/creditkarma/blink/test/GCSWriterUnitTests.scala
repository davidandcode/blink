...
object GCSWriterUnitTests {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //println(mGCSSubPartition.year)
    //println(mGCSSubPartition.month)
    //println(mGCSSubPartition.day)
    ...
    //println(mGCSSubPartition2.year)
    //println(mGCSSubPartition2.month)
    //println(mGCSSubPartition2.day)



    var testString3: String = "{\"schemaName\":\"Accident.json\",\",\"ts\":\"1991-01-07T14:22:35.8613-0800\"}"

    testString3 = testString2

    val mGCSSubPartition3: GCSSubPartition = mGCSWriter.getSubPartition(testString3)

    //println(mGCSSubPartition3.year)
    //println(mGCSSubPartition3.month)
    //println(mGCSSubPartition3.day)

    val testTopicPartition: TopicPartition = new TopicPartition("SaturdayNight", 5)
    ...
    val year = mGCSWriter.getSubPartition(singleRecord1.value).year
    val month = mGCSWriter.getSubPartition(singleRecord1.value).month
    val day = mGCSWriter.getSubPartition(singleRecord1.value).day
