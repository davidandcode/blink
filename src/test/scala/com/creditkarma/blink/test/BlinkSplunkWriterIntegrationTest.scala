...
class BlinkSplunkWriterIntegrationTest extends FlatSpec with KafkaIntegrationTest[String, String] with SparkLocalMaster  {
  ...
  "A writer" should "upload the data/message correctly" in {
    ...
    val fileName = s"$dir/kafka_splunk.properties"
    new File(dir).mkdirs()
...
s"""
   ...
   |blink.portal.factory.properties.writer.creator.class=com.creditkarma.blink.impl.spark.exporter.kafka.splunk.SplunkWriterCreator
   ...
   |
 |#===================================================================================================
   |# Client configurations -- Splunk Writer
   |#===================================================================================================
   |blink.portal.factory.properties.writer.creator.properties.index=test_index
   |blink.portal.factory.properties.writer.creator.properties.indexers=localhost
   |blink.portal.factory.properties.writer.creator.properties.user=admin
   |blink.portal.factory.properties.writer.creator.properties.password=changemeyes
   |blink.portal.factory.properties.writer.creator.properties.port=8089
   |
 |#===================================================================================================
