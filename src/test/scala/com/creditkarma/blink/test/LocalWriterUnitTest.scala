...
import com.creditkarma.blink.impl.spark.exporter.kafka.local.LocalWriter
...
/**
  ...
  *
  */
class LocalWriterUnitTest  extends FlatSpec{


  val mWriter = new LocalWriter("src/test/resources/generated_local_output","testfile")
  ...
  "A writer" should "upload the data/message correctly" in {
    ...
    val payload1 = "This is the 1st message for Blink's local writer test."
    val payload2 = "This is the 2nd message for Blink's local writer test."
    val payload3 = "This is the 3rd message for Blink's local writer test."
